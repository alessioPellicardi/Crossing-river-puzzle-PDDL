...
def callback():
    ...
    if selected_option == "Wolf Cabbage Sheep":
        os.chdir("./CROSSING_RIVER_GRAPHICS/LPC/")
        subprocess.call(["python", "WCSGraphics.py"])

    elif selected_option == "Jeaolus Husbands: 2 couples":
        os.chdir("./CROSSING_RIVER_GRAPHICS/2Couples/")
        subprocess.call(["python", "2CouplesGraphics.py"])

    elif selected_option == "Jealous Husbands: 3 couples":
        os.chdir("./CROSSING_RIVER_GRAPHICS/3Couples/")
        subprocess.call(["python", "3CouplesGraphics.py"])


accentbutton = ttk.Button(root, text='AVVIA', style='Accentbutton', command=callback)
