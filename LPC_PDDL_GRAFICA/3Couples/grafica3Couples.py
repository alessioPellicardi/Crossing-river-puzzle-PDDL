...
subprocess.call([r'C:/Users/alela/Desktop/UNIVERSITA/AI/LPC_PDDL/LPC_PDDL_GRAFICA/3Couples/esecutore3Couples.bat'])
...
for string in var_lettura:
    ...
    if (cont == 3):
        ...
        image_name = command + "-3.png"
        image_array.append(image_name)
    elif (cont == 9):
        image_name = command + "-3.png"
        image_array.append(image_name)
    elif (cont == 10):
        image_name = command + "-4.png"
        image_array.append(image_name)
    elif (cont == 11):
        image_name = command + "-4.png"
        image_array.append(image_name)
...
image_array.insert(0, "startingPoint3Couples.png")
image_array.insert(len(image_array), "finalSituation3Couples.png")
